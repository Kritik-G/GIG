...
<footer class="bg-gray-900 text-white py-12">
    <div class="container-max mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <!-- Company Info -->
            <div class="fade-in">
                <h3 class="text-2xl font-bold mb-4">Your Company</h3>
                <p class="text-gray-400 mb-4">
                    Driving innovation and transforming businesses with cutting-edge solutions.
                </p>
            ...
            <div class="fade-in">
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><span class="font-semibold">Email:</span> <a href="mailto:info@yourcompany.com"
                            class="hover:text-blue-400 transition-colors duration-300">info@yourcompany.com</a></li>
                    <li><span class="font-semibold">Phone:</span> <a href="tel:+1234567890"
                            class="hover:text-blue-400 transition-colors duration-300">+1 (234) 567-890</a></li>
                    <li><span class="font-semibold">Address:</span> 123 Innovation Drive, Tech City, TC 12345</li>
                </ul>
            </div>
            ...
            <div class="fade-in">
                ...
                <p class="text-gray-400 mb-4">Stay updated with our latest innovations and offers.</p>
